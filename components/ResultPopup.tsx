...
export default function ResultPopup({ item, onLike, onDislike, appConfig }: Props) {
  useEffect(() => {
    ...
    <div className="popup-overlay active">
      <div className="popup-box">
        ...
        <div className="popup-actions">
          <button className="btn-secondary" onClick={onDislike}>
            {appConfig.dislikeButtonText}
          </button>
          <button className="btn-primary" onClick={onLike}>
            {appConfig.likeButtonText}
          </button>
        </div>
      </div>
    </div>
